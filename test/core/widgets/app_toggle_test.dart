  ...
  group('AppToggle', () {
    testWidgets('renders in off state (BM track color)', (tester) async {
      await tester.pumpWidget(
        _wrap(AppToggle(value: false, onChanged: (_) {})),
      );
      await tester.pump();
    ...
    testWidgets('tap calls onChanged(true) when off', (tester) async {
      bool? received;
      await tester.pumpWidget(
        _wrap(AppToggle(value: false, onChanged: (v) => received = v)),
      );
    ...
    testWidgets('tap calls onChanged(false) when on', (tester) async {
      bool? received;
      await tester.pumpWidget(
        _wrap(AppToggle(value: true, onChanged: (v) => received = v)),
      );
      await tester.tap(find.byType(AppToggle));
