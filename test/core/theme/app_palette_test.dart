...
void main() {
  ...
  group('the dark palette is readable', () {
    ...
    test('semantic colours clear AA rather than staying their light-theme selves', () {
      for (final entry in {
        ...
        expect(contrast(entry.value, d.bg2), greaterThan(4.5),
    ...
    test('inverse ink reads on the inverse surface', () {
      ...
      expect(contrast(AppPalette.light.inkInverse, AppPalette.light.surfaceInverse),
          greaterThan(4.5));
    });
    ...
    test('surfaces step apart enough to read as layers', () {
      ...
      expect(contrast(d.surface, d.bg1), greaterThan(1.05),
  ...
  group('the theme carries the palette', () {
    ...
    testWidgets('text colour comes from the palette, in both themes', (tester) async {
      ...
      expect(buildAppTheme(brightness: Brightness.dark).textTheme.bodyMedium!.color,
          AppPalette.dark.ink);
      expect(buildAppTheme(brightness: Brightness.dark).textTheme.displayLarge!.color,
          AppPalette.dark.ink);
    });
  ...
  test('screens read colour from the theme, not from constants', () {
    ...
    expect(offenders, isEmpty,
        reason: 'Use context.colors.* so the value follows the theme. If the surface underneath '
