...
/// A list row's leading icon — an accent-chip cut into the card (12%-alpha fill, solid-accent
/// icon), not the earlier Cassetta-era solid dark case-shell square this used to paint on every
/// list row in the app regardless of theme.
///
/// ```dart
